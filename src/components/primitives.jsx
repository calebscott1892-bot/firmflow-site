...
/** Product signature motif (decorative). FirmFlow = an AI sparkle. */
export function Motif({ size = 16, className = '' }) {
  return (
    <span className={`inline-flex items-center text-accent ${className}`} aria-hidden="true">
      <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2l1.9 5.6L19.5 9.5l-5.6 1.9L12 17l-1.9-5.6L4.5 9.5l5.6-1.9z" />
        <path d="M19 13l.8 2.2L22 16l-2.2.8L19 19l-.8-2.2L16 16l2.2-.8z" opacity="0.85" />
      </svg>
    </span>
  );
}
